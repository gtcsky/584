...
#define	 QUICK_CHANGE_MODE		2

#define  KEY_MAX								5
#define  KEY_POWER_ON							0x01
#define  KEY_POWER_OFF							0x80

#define  KEY_LIGHT_UP							0x02
#define	LONG_LIGHT_UP							0x00000200
#define	LONG_LIGHT_GOT						0x00020000
#define	LIGHT_HOLDING							0x02000000
#define	CLEAR_UP_KEY_INFO						(~0x02020202)

#define  KEY_LIGHT_DOWN						0x04
#define	CLEAR_DOWN_KEY_INFO					(~0x04040404)
#define  KEY_ARROW								0x08
#define	CLEAR_ARROW_KEY_INFO					(~0x08080808)

#define  KEY_MODE								0x10
#define  KEY_MODE_LONG						0x1000

#define	CLEAR_MODE_KEY_INFO					(~0x10101010)
#define  KEY_CHARGE_DET						0x20
#define  KEY_CHARGE_FULL						0x40

#define	QUICK_KEYS_START_TIMES				25			//500MS
#define	LONG_UP_KEY_TIMES						100			//2000
#define	LONG_MODE_KEY_TIMES					20			//400
#define	KEYS_MASK								0x0000FFFF
/*********************************************************************
* CONSTANTS
*/
...
/***********************************************************************************************************
  ...
  *  @note :
  ************************************************************************************************************/
extern void userKeysAdapter(uint8 inKeys,uint32 * value);
