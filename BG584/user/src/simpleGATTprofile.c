...
// 0 Simple Profile Service
		...
		GATT_PERMIT_READ | GATT_PERMIT_WRITE, 0, simpleProfileChar3 },
		...
		GATT_PERMIT_READ, 0, (uint8*) &simpleProfileChar4 },
		...
		GATT_PERMIT_READ, 0, (uint8*) &simpleProfileChar5 },
...
//		GATT_PERMIT_READ| GATT_PERMIT_WRITE|GATT_PROP_NOTIFY,
				GATT_PERMIT_READ | GATT_PERMIT_WRITE, 0, (uint8*) &simpleProfileChar6 },

		// 19 Characteristic 6 configuration
		{ { ATT_BT_UUID_SIZE, clientCharCfgUUID },
//		GATT_PERMIT_READ| GATT_PERMIT_WRITE|GATT_PROP_NOTIFY,
				GATT_PERMIT_READ | GATT_PERMIT_WRITE, 0, (uint8*) simpleProfileChar6Config },
...
//			LOG("1=%08x /t 2=%02x,%02x,%02x \t 3=%08x	\n",simpleProfileChar4Config[0],simpleProfileChar4[1],simpleProfileChar4[2],GATT_NUM_ATTRS(simpleProfileAttrTbl));
		GATTServApp_ProcessCharCfg(simpleProfileChar4Config, simpleProfileChar4, FALSE, simpleProfileAttrTbl, GATT_NUM_ATTRS(simpleProfileAttrTbl),
		INVALID_TASK_ID);
		break;
...
//			LOG("1=%02x /t 2=%02x,%02x,%02x \t 3=%02x",simpleProfileChar6[0],simpleProfileChar6[1],simpleProfileChar6[2],GATT_NUM_ATTRS(simpleProfileAttrTbl));
		GATTServApp_ProcessCharCfg(simpleProfileChar6Config, simpleProfileChar6, FALSE, simpleProfileAttrTbl, GATT_NUM_ATTRS(simpleProfileAttrTbl),
		INVALID_TASK_ID);
		break;
	default:
