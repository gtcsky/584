           ...
           )
{
    ...
    switch (event_type)
    {
        ...
        case PROV_EVT_PROVDATA_INFO_REQ:
            ...
            printf ("NetKey  : "); appl_dump_bytes(appl_prov_data.netkey, PROV_KEY_NETKEY_SIZE);
        ...
        case PROV_EVT_PROVDATA_INFO:
            ...
            printf ("NetKey  : "); appl_dump_bytes(rdata->netkey, PROV_KEY_NETKEY_SIZE);
            printf ("Key ID  : 0x%04X\n", rdata->keyid);
            printf ("Flags   : 0x%02X\n", rdata->flags);
            printf ("IVIndex : 0x%08X\n", rdata->ivindex);
            printf ("UAddr   : 0x%04X\n", rdata->uaddr);
...
void main_prov_operations (void)
{
    ...
    while (1)
    {
        ...
        case 12:
            printf ("Select the Bearer (0: PB-ADV, 1: PB-GATT): "); fflush (stdout);
            scanf ("%d", &choice);
